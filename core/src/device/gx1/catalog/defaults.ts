 ...
 * generic guess. Kept honest by the drift guard in `tests/device/gx1/catalog/defaults.test.ts`, which
 ...
 *
 * Regenerate after a fixture change: see `tests/device/gx1/catalog/defaults.test.ts`.
 */
