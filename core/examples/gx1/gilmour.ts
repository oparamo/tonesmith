...
fx(hy1, "fx2", "CHORUS", "STEREO", { rate: 12, depth: 20, level: 50, preDelay: 3 });
clearOdds(hy1);
ns(hy1, 30, 40);
...
clearOdds(mar1);
ns(mar1, 22, 65);
delay(mar1, "MODULATE", 1, 38, 50, "2.5kHz", true, { modRate: 12, modDepth: 18 });
...
ns(mar2, 28, 60);
delay(mar2, "MODULATE", 1, 40, 55, "3.15kHz", true, { modRate: 10, modDepth: 15 });
