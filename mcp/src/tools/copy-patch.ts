  ...
  server.registerTool(
    "copy_patch",
    {
      description:
        ...
        "files must already exist. To add a patch without displacing one, build it with the " +
        "device's generate tool instead, which appends by name.",
