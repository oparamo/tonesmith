 ...
 * field in, so they belong in the description rather than only in describe_device. Writing them out
 * by hand would let the schema drift from the device the moment a type is added or renamed.
 */
