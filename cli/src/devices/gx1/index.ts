...
const gx1Cli: CliDescriptor = {
  ...
  // The id ↔ patch-type pairing ("gx1" always yields a PatchDriver<gx1.Patch>) is a fact
  // the roster's device-agnostic CliDescriptor type can't express — safe here because this
  // module is gx1-owned code, not the generic dispatcher.
